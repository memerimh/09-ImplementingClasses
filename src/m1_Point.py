...
"""  # TOOO: 1. PUT YOUR NAME IN THE ABOVE LINE.
...
########################################################################
class Point(object):
    """Variable that keeps track of specific locations in 2-space"""
    ...
    def move_by(self, dx, dy):
        self.travelled = self.travelled + math.sqrt((dx ** 2) + (dy ** 2))
        self.x = self.x + dx
        self.y = self.y + dy
        self.moves = self.moves + 1
...
def run_test_repr():
    ...
    """
    # ------------------------------------------------------------------
    # TDO: 4.  Follow the same instructions as in TO-DO 3 above,
...
def run_test_clone():
   ...
   """
    # ------------------------------------------------------------------
    # TODD: 5.  Follow the same instructions as in TO-DO 3 above,
...
def run_test_move_to():
    ...
    """
    # ------------------------------------------------------------------
    # DOO: 6.  Follow the same instructions as in TO-DO 3 above,
...
def run_test_move_by():
    ...
    """
    # ------------------------------------------------------------------
    # TOO: 7.  Follow the same instructions as in TO-DO 3 above,
...
def run_test_get_number_of_moves_made():
    ...
    """
    # ------------------------------------------------------------------
    # ODO: 8.  Follow the same instructions as in TO-DO 3 above,
...
def run_test_get_distance_from():
    ...
    """
    # ------------------------------------------------------------------
    # TOO: 9.  Follow the same instructions as in TO-DO 3 above,
...
def run_test_get_distance_from_start():
    ...
    """
    # ------------------------------------------------------------------
    # TODOD 10.  Follow the same instructions as in TO-DO 3 above,
...
def run_test_get_distance_traveled():
    ...
    """
    # ------------------------------------------------------------------
    # TDO: 11.  Follow the same instructions as in TO-DO 3 above,
...
def run_test_closer_to():
    ...
    """
    # ------------------------------------------------------------------
    # TOD: 12.  Follow the same instructions as in TO-DO 3 above,
...
def run_test_halfway_to():
    ...
    """
    # ------------------------------------------------------------------
    # TOO: 13.  Follow the same instructions as in TO-DO 3 above,
